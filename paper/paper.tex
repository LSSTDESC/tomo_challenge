...
explored before in \citet{jain} and \citet{kitching2019} \textbf{more}.  In this paper we describe the results of a 
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{results/initial_data.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1\linewidth]{results/colour_colour.pdf}
