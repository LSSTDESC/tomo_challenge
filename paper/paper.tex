...
this, so to make the final evaluation of methods tractable we used 1M objects for both data sets when
computing the metrics presented in this paper.
...
\begin{table*}[]
	...
	\textsc{ComplexSOM} & Extension of {\sc SimpleSom} with an additional assignment optimization & DA, AHW, AN, EG, BA \\
...
\begin{figure}[htbp]
	...
	\caption{The tomographic $n(z)$ values generated by the winning method in the challenge, {\sc funbins},
		...
		and illustrates results using all the $ugrizy$ bands.
...
An illustration of the rank achieved by each method within each challenge configuration and for each metric
