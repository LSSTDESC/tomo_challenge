...
\emph{ww} indicates lensing-only metrics, \emph{gg} indicates clustering only, and \emph{3x2pt} their combination.
...
could plausibly favour methods that are better in that range.
...
These method were submitted by the author AP.
