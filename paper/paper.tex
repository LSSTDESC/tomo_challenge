...
total number density over all bins of 20 galaxies per square arcminute) and $\sigma_e=0.26$, roughly matching that found in previous surveys \citep{des,kids,hsc}.
