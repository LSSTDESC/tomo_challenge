...
This methi submitted by the author AP. 
 
JaxCNN and JaxResNet are a convolutional neural network based algorithm that
maps the relationship between the color-magnitude data of galaxies to their bin
...
problem, hence we can have a deeper neural network.
...
This method uses the random forest algorithm described in section \ref{sec:randomforest} to assign galaxies to tomographic bins. There are 3 options for determining the bins used to assign labels to the training data - \textit{log}, \textit{random}, and \textit{chi}. 
