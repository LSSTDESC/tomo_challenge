...
our final results by running each method in turn and checking for new files in the working
directory.}.  
...
\begin{rotatetable*}
\begin{deluxetable*}{ |l | c c c | c c c | c c c | c c c | c c c | c c c |}
\tablecaption{The 9-bin results for all the metrics calculated for all methods on the Buzzard sample. 
\textit{ww} are weak-lensing metrics, \textit{gg} clustering, and \textit{3x} the full 3x2pt.
\label{tab:full_buzz}
}
\tablehead{
