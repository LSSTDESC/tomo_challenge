...
This method was {\sc Utopia}, which, as described in \ref{sec:utopia}, found, for each object in the testing data, the
...
The methods were (with the submitting authors listed in brackets):
...
\begin{description*}
	...
	\item[\textsc{ComplexSOM}] an extension of {\sc SimpleSom} with an additional assignment optimization (DA, AHW)
	...
	\item[\textsc{Utopia}] a nearest-neighbour method, not applicable to real data (AHW)
...
These methods are described in full in \autoref{app:methods}
...
are availanble online.  Missing entries occured in two ways.
...
This method was submitted by author DA.
