...
\tablecaption{The 9-bin results on the CosmoDC2 data set for all the metrics and all methods.
 \label{tab:full_dc2}}
\tablehead{
...
\begin{rotatetable*}
\begin{deluxetable*}{ |l | c c c | c c c | c c c | c c c | c c c | c c c |}
\tablecaption{The 9-bin results for all the metrics calculated for all methods. \textbf{Incomplete.} \label{tab:full_buzz}}
\tablehead{
\colhead{Method} & \multicolumn{9}{c|}{riz} & \multicolumn{9}{c|}{griz}
}
\startdata
