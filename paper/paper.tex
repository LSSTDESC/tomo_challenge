...
subsequent science anlysis; this will probably be true even when comparing models with
different systematic parametrizations.  
...
the figure of merit $F$, where $F$ is defined in \ref{eq:fom}. We implement
