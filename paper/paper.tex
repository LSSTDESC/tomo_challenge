...
at redshifts dominated by different tomographic to the ones they are assigned.  This metric corresponds to
...
that are ambiguous over all bins, and is the sum of all the grid values.}
\label{fig:overlap}
\end{figure*}
