...
simulations were then used, in a combination of empirical and semi-analytic
...
used at high redshifts, and thus to many galaxies in the simulations sharing
...
It is clear from values here that fears about restricted photometry catastrophically limiting
...
\caption{Add $n(z)$ plots here for funbins.}
\label{fig:metrics}
\end{figure}
