...
**The deadline to enter the challenge is Friday September 4th 2020 (AoE)**, i.e. Pull Requests decribing your entry need to be open by that time to be considered. Participants who have entered the competition by that date will be given until **Monday September 14th (AoE)** to fine tune their entry, at which point their entry will be considered final.
